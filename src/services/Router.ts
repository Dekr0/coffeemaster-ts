...
function init() {
    ...
    window.addEventListener('popstate', e => {
        ...
        go(state.route, false);  // Avoid pushing popped state back into the History API
    });
...
function go(route: string, addToHistory: boolean=true) {
    ...
    switch (route) {
        ...
        default: {
            ...
            break;
        } // detail page (page content is varied by products)
    }
